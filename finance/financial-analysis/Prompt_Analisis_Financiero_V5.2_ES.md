# PROMPT PROFESIONAL V5.2 — PIPELINE DE RESEARCH FINANCIERO CON PDF Y SCRIPT BRIEF BAJO DEMANDA

> Cambios V5.2 frente a V5.1: se añade la **Regla de Reconciliación de niveles**
> en la Secuencia 6 (y su control en la Secuencia 8). Todo nivel de precio
> dibujable que aparezca en el informe debe estar en el Script Brief o figurar
> explícitamente en "Lagunas" con su motivo de exclusión — nunca desaparecer en
> silencio.
>
> (V5.1 ya incorporaba: completitud obligatoria de secuencias, atribución de
> opiniones en la narrativa, tipo inequívoco indicador/estrategia, sección de
> no-repaint a nivel de requisitos, y aviso de indicador genérico parametrizable.)
>
...
10. Auditoría final (incluye control de completitud, atribución y reconciliación).
